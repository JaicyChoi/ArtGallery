...
for( let i = 0 ; i < DATA.Atelier.length ; i++ ){
    ...
    img.src = 'img/atelier/' + DATA.Atelier[i].file + '.png';
    img.alt = DATA.Atelier[i].nickname + ' 그림';
    hover_info_date.innerHTML = DATA.Atelier[i].date;
    hover_info_nickname.innerHTML = DATA.Atelier[i].nickname;
...
wrapper_li.forEach( (li, index) => li.addEventListener('click', () => {
    ...
    img.src = 'img/atelier/' + DATA.Atelier[index].file + '.png';
    img.alt = DATA.Atelier[index].nickname + ' 그림';
    show_pic_info_date.innerHTML = DATA.Atelier[index].date;
    show_pic_info_nickname.innerHTML = DATA.Atelier[index].nickname;
